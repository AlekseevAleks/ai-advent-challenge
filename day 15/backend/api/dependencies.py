...
def get_memory_service() -> MemoryService:
    ...
    return MemoryService(
        ...
        profile_repo=UserProfileRepository(get_db()),
        task_repo=TaskStateRepository(get_db()),
        invariant_repo=InvariantRepository(get_db()),
        state_repo=TaskStateDefinitionRepository(get_db()),
        rule_repo=TransitionRuleRepository(get_db()),
        history_repo=TransitionHistoryRepository(get_db()),
    )
